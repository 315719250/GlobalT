...
@interface TravelHealthVC ()<UITableViewDataSource,UITableViewDelegate>
...
-(void)loadData
{
    NSString *str = [NSString stringWithFormat:@"http://apps.caredsp.com/openinterface/gethelperbypage.ashx?page=%ld&pagesize=10&classes=%%E6%%97%%85%%E6%%B8%%B8%%E6%%94%%BB%%E7%%95%%A5%%E7%%99%%BE%%E7%%A7%%91_%%E6%%97%%85%%E8%%A1%%8C%%E5%%81%%A5%%E5%%BA%%B7&deviceTypeId=1&typeid=7",self.i];
...
- (void)viewDidLoad {
    ...
    imgView.image = [UIImage imageNamed:@"background_2.jpg"];
    [self.view addSubview: imgView];
    
    self.navigationItem.title = @"旅行健康";
...
{
     TravelHealthCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
//    [cell.imgView sd_setImageWithURL:[NSURL URLWithString:model.p]];
    [cell.imgView sd_setImageWithURL:[NSURL URLWithString:model.p] placeholderImage:[UIImage imageNamed:@"background_4.jpg"]];
