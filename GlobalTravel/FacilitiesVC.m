...
@interface FacilitiesVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation FacilitiesVC

//数据解析
-(void)loadData
{
    NSString *str = [NSString stringWithFormat:@"http://apps.caredsp.com/openinterface/gethelperbypage.ashx?page=%ld&pagesize=10&classes=%%E6%%97%%85%%E6%%B8%%B8%%E6%%94%%BB%%E7%%95%%A5%%E7%%99%%BE%%E7%%A7%%91_%%E6%%97%%85%%E8%%A1%%8C%%E8%%A3%%85%%E5%%A4%%87&deviceTypeId=1&typeid=7",self.i];
...
- (void)viewDidLoad {
    ...
    imgView.image = [UIImage imageNamed:@"background_3.jpg"];
    [self.view addSubview: imgView];
    
    
    self.navigationItem.title = @"旅行工具";
...
{
    FacilitiesCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
